...
Camera::Camera(CamEnum CameraType)
{
	m_eType = CameraType;
	m_bKeepMatrix = true;
...
void Camera::SetValuev(CamEnum PName, float *v)
{
	float *pTemp;
	pTemp = nullptr;
...
void Camera::SetValue(CamEnum PName, float v1, float v2, float v3)
{
	float temp[] = {v1, v2, v3};
...
void Camera::SetValue(CamEnum PName, float v)
{
	switch(PName)
	{
		case ASPECT:
...
void Camera::SetType(CamEnum Ctype)
{
	m_eType=Ctype;
}
